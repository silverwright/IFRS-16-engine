...
return `
  ...
  <tr>
    ...
    <p>4.2 Late amounts accrue default interest at the maximum rate permitted by law.</p>
    <p style="margin-bottom: 1.5rem;">4.3 Escalation: Rent is adjusted by reference to ${leaseData.EscalationType || 'CPI'} (Base ${leaseData.BaseCPI || 0}), reset in month 1, first reset ${leaseData.EscalationResetYears || 1} year(s) after commencement. If CPI is discontinued or materially changed, the Parties shall in good faith select a
    ...
    <p style="margin-bottom: 1.5rem;">All amounts are exclusive of taxes. If Lessee is required by law to withhold or deduct taxes from a
