...
The IFRS 16 Lease Engine now supports **contract modifications with version tracking**. This feature allows you to modify lease contracts (e.g., change payment amounts or IBR) while preserving historical calculations and applying new values only from the modification date forward.
...
- ✅ **IFRS 16 Compliant**: Follows lease modification accounting principles
